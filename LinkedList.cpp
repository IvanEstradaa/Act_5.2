...
// La complejidad del SetAt es O(n) ya que se recorre la lista hasta llegar a la posicion deseada
...
// La complejidad de Compara es O(1) ya que solo se comparan los octetos de las direcciones ip
...
void LinkedList::bubbleSort() {
    ...
    do {
        ...
        while (current->next != lastSorted && current->next != nullptr) {
            ...
            if (Compara(current, current->next)) {
                // Swap if needed
